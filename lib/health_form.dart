...
class HealthForm extends StatefulWidget {
  ...
  const HealthForm({super.key, required this.faceAgeEstimate});
...
class _HealthFormState extends State<HealthForm> {
  ...
  void _calculate() {
    ...
    // ✅ ЗАМЕНА: pushReplacement удаляет форму из стека навигации
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Анкета здоровья"),
        ...
        child: ListView(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: const Text("Рассчитать биовозраст", style: TextStyle(color: Colors.black)),
            ),
          ],
        ),
      ),
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Text(value.round().toString(), style: const TextStyle(color: Color(0xFF00D4AA), fontWeight: FontWeight.bold)),
          ],
        ),
        Slider(
          value: value,
